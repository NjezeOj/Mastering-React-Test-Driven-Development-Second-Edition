...
import { fetchResponseOk } from "./builders/fetch";
  ...
  // In the preceding code, Jest hoists this call to the top of the file 
  // and hooks into import logic so that when the import statement is run, 
  // your mock is returned instead.
