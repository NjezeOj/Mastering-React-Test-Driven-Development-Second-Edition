...
export const AppointmentForm = ({selectableServices, original, salonOpensAt,
    salonClosesAt, today, availableTimeSlots, onSubmit}) => {
    ...
    return(
        ...
        <TimeSlotTable salonOpensAt={salonOpensAt} 
